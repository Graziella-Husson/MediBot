...
#    print(corrected)
    ...
    moderate = ["moving table", "pushing vacuum cleaner", "moving stuff",
                ...
                "Cricket", "bowling", "badminton", "archery", "fencing",
                ...
                "general home construction work", "roofing", "painting",
                "wall papering", "scraping", "plastering",
                ...
                "picking fruit from trees", "picking vegetables",
                "packing boxes for shipping or moving",
                "assembly-line work", "mail carriers", "dressing",
                "moving patients", "Walking briskly",
